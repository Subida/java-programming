...
public class StudentArray {
    public static void main(String[] args) {
        ...
        /**
         * check if student1 and student2 arrays have some number of data
         * ture: pass: data arrays length match
        ...
        System.out.println(student1[1]);//Adam
        System.out.println(student1[1].toUpperCase());//ADAM
        System.out.println(student1[1].toUpperCase() + " " + student1[2].toUpperCase());//ADAM SMITH
